...
namespace Niki {
    public class ArtistPango : GLib.Object {
        ...
        public ArtistPango (PlayerPage playerpage, Clutter.Text c_text) {
            this.playerpage = playerpage;
            this.c_text = c_text;
            c_text.font_name = "Lato 15";
            ...
            NikiApp.settings.changed["artist-music"].connect (()=>{
                if (remove_time > 0) {
