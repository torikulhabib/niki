namespace niki {
    public class EqualizerGrid : Gtk.Grid {
        ...
        private EqualizerPresetList? equalizer_preset_list;
        ...
        public void init () {
            ...
            if (preset != null) {
                equalizer_preset_list.select_preset (preset);
            }
            on_eq_switch ();
            apply_changes = true;
        }
        ...
        public bool verify_preset_name (string preset_name) {
            ...
            foreach (var preset in equalizer_preset_list.get_presets ()) {
        ...
        private void build_ui () {
            ...
            equalizer_preset_list = new EqualizerPresetList ();
            equalizer_preset_list.hexpand = true;

            side_list = new Gtk.Grid ();
            side_list.add (equalizer_preset_list);
            ...
            size_group.add_widget (equalizer_preset_list);
            ...
            equalizer_preset_list.delete_preset_chosen.connect (remove_preset_clicked);
            equalizer_preset_list.preset_selected.connect (preset_selected);
        ...
        private void load_presets () {
            foreach (var preset in AudioMix.get_default_presets ()) {
                ...
                equalizer_preset_list.add_preset (preset);
            }
        ...
        private void notify_current_preset () {
            if (NikiApp.settingsEq.get_boolean ("equalizer-enabled")) {
                NikiApp.settings.set_string ("tooltip-equalizer", equalizer_preset_list.get_selected_preset ().name);
            } else {
                NikiApp.settings.set_string ("tooltip-equalizer", StringPot.None);
            }
        }
        ...
        private void on_default_preset_modified () {
            ...
            adding_preset = true;
            side_list.remove (equalizer_preset_list);
        ...
        private void add_new_preset () {
            ...
            equalizer_preset_list.add_preset (new_preset);
            side_list.add (equalizer_preset_list);
            side_list.set_focus_child (equalizer_preset_list);
        ...
        private string create_new_preset_name (bool from_current) {
            string current_preset_name = from_current ? equalizer_preset_list.get_selected_preset ().name : "";
            string preset_name = "";
            bool is_valid = false;
            int i = 0;
        ...
        private void remove_preset_clicked () {
            equalizer_preset_list.remove_current_preset ();
        }
    }
}
