...
public class Niki.Gst.Spectrum : global::Gst.Audio.Filter {
    ...
    static construct {
        ...
        set_static_metadata ("Hottoe Spectrum analyzer", "Filter/Analyzer/Audio", "Run an FFT on the audio signal, output logarithm spectrum data", "Nicolas Bruguier <gandalfn@club-internet.fr>");
...
[CCode (cname = "niki_gst_spectrum_init")]
public static bool plugin_init (Gst.Plugin in_plugin) {
    return Gst.Element.register (in_plugin, "nikispectrum", Gst.Rank.NONE, typeof (Niki.Gst.Spectrum));
}
